...
public class NoteBlogDAO extends DAO {
    ...
    public List<NoteBlog> getLatestArticleList() throws Exception {
        ...
        String sql = "SELECT id, title, uploadDate, content FROM articles ORDER BY uploadDate DESC LIMIT 5";
   ...
   /**
    ...
    public NoteBlog readLatestArticle() throws Exception {
        ...
        String sql = "SELECT id, title, uploadDate, content FROM articles ORDER BY uploadDate DESC LIMIT 1";
